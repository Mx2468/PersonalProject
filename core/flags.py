"""A class to represent optimisation flags"""
...
class Flags:
    ...
    def remove_flag(self, flag_name: str) -> None:
        ...
        :param flag_name: The name of the flag to remove from this object
        """
    ...
    def add_flag(self, flag_name: str, domain, default_value) -> None:
        ...
        :param flag_name: The name of the flag to add
        :param domain: The domain of possible values for the flag
        :param default_value: The default/desired value for the flag
        """
    ...
    def get_all_flag_names(self) -> list[str]:
        ...
        :return: A list of all the flag names present in the object
        """
        return self.all_flag_names

    def get_domain_flag_defaults(self) -> dict[str, str]:
        """
        Returns a dictionary mapping each domain flag name to its default value

        :return: A dictionary mapping the domain flag to its default value
        """
    ...
    def get_all_flag_domains(self) -> dict[str, str|list[str]|list[bool]]:
        ...
        :return: A dictionary mapping each flag name to its domain
        """
    ...
    def get_flag_domain(self, flag_name: str) -> str|list[str]|list[bool]:
        ...
        :param flag_name: The name of the flag to get the domain for
        :return: The domain for the flag provided
        """
        return self.flag_domains[flag_name]

    def get_flag_default(self, flag_name: str) -> str|bool:
        """
        Returns the default value for a given flag name
